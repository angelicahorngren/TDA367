...
public class CollisionDetectorTest {
    ...
    void playerObstacleNotCollidedTest() {
        ...
        CollisionDetector collisionDetector = new Model.CollisionDetector(playerCollisionTest, obstacleCollisionTest, null);
    ...
    void playerObstacleCollidedTest() {
        ...
        Obstacle obstacleCollisionTest = new Obstacle(Constants.RECT_WIDTH, Constants.RECT_HEIGHT, 0, true, 0 + Constants.RECT_WIDTH, Constants.Y_POS);
        CollisionDetector collisionDetector = new Model.CollisionDetector(playerCollisionTest, obstacleCollisionTest, null);
        collisionDetector.detectCollision();
