...
public class CollisionDetectorTest {
    ...
    void playerObstacleNotCollidedTest() {
        ...
        Object obstacleCollisionTest = new Object(Constants.RECT_WIDTH, Constants.RECT_HEIGHT, 0, 0, Constants.Y_POS);
    ...
    void playerObstacleCollidedTest() {
        ...
        Object obstacleCollisionTest = new Object(Constants.RECT_WIDTH, Constants.RECT_HEIGHT, 0, 0 + Constants.RECT_WIDTH, Constants.Y_POS);
        CollisionDetector collisionDetector = new Model.CollisionDetector(playerCollisionTest, obstacleCollisionTest);
        collisionDetector.detectCollision();
