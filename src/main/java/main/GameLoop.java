...
public class GameLoop {       //Have to extend JFrame for add()-functions to work, still working on this
    ...
    public GameLoop(Player player, Obstacle obstacle, PowerUp powerUp, GameView gameView, ProgressBar progressBar, CollisionDetector collisionDetector, PlayerMouseController mouseListener){
