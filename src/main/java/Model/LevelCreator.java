...
public class LevelCreator {
    ...
    public void createLevel(){
        obstacles.add(new Obstacle(Constants.RECT_WIDTH, Constants.RECT_HEIGHT, Constants.OBSTACLE_SPEED, true, Constants.OBSTACLE_START_X, Constants.OBSTACLE_START_Y));
